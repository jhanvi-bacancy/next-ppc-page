...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        arrowdownOrange:
          'url("https://assets.bacancytechnology.com/main-boot-5/images/tailwind/images/down-arrow-orange.svg")',
        arrowdown:
          'url("https://assets.bacancytechnology.com/main-boot-5/images/tailwind/images/down-arrow.svg")',
        rightarrowLine:
          'url("https://assets.bacancytechnology.com/main-boot-5/images/tailwind/images/right-arrow-line.svg")',
        rightarrowLineBlack:
          'url("https://assets.bacancytechnology.com/main-boot-5/images/tailwind/images/right-arrow-line-black.svg")',
        arrowrightOrange:
          'url("https://assets.bacancytechnology.com/main-boot-5/images/tailwind/images/right-arrow-small-orange.svg")',
      },
      fontSize: {
        base: [
          "max(18px,1.25vw)",
